...
| Autores: [*Pablo Tiscornia*]() y [*Patricia Loto*](https://github.com/PatriLoto)
...
```{r echo=FALSE, out.width = "480px", out.height="480px",fig.align='center'}
knitr::include_graphics("https://media.giphy.com/media/fXsfNy8saoEgMo0Nc9/giphy.gif")
```
